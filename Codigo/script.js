    ...
    setTimeout(() => {
        ...
        const resultadoHTML = `
            <div style="text-align: center;">
                ...
                <strong style="font-size: 2.2em; color: #3ca95e; font-weight: 700;">${resultadoFinal.toFixed(2)}</strong>
                <span style="font-size: 1.2em; color: #122344;">${unidadeResultado}</span>
            </div>
        `;
